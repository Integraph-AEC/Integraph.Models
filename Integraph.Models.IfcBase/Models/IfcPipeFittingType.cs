...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcPipeFittingType : IfcFlowFittingType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcPipeFittingType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcPipeFittingTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcPipeFittingType FromJson(string json)
        {
