...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcProtectiveDeviceTrippingUnitType : IfcDistributionControlElementType
    {
	    ...
	    /// </summary>
	    public IfcProtectiveDeviceTrippingUnitType(IfcGloballyUniqueId globalId,
            IfcProtectiveDeviceTrippingUnitTypeEnum predefinedType) : base(globalId)
        {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcProtectiveDeviceTrippingUnitType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory,
            ...
            IfcLabel elementType, IfcProtectiveDeviceTrippingUnitTypeEnum predefinedType) : base(globalId, ownerHistory,
        ...
        public new static IfcProtectiveDeviceTrippingUnitType FromJson(string json)
        {
