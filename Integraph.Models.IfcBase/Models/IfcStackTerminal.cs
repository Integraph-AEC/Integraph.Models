...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcStackTerminal : IfcFlowTerminal
    {
        ...
        public IfcStackTerminal(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcStackTerminalTypeEnum predefinedType) : base(
        ...
        public new static IfcStackTerminal FromJson(string json)
        {
