...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcCableFittingType : IfcFlowFittingType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcCableFittingType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcCableFittingTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcCableFittingType FromJson(string json)
        {
