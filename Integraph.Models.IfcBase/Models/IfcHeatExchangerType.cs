...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcHeatExchangerType : IfcEnergyConversionDeviceType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcHeatExchangerType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcHeatExchangerTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcHeatExchangerType FromJson(string json)
        {
