...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcRampFlight : IfcBuildingElement
    {
        ...
        public IfcRampFlight(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcRampFlightTypeEnum predefinedType) : base(
        ...
        public new static IfcRampFlight FromJson(string json)
        {
