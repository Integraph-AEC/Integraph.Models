...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcElectricGenerator : IfcEnergyConversionDevice
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcElectricGenerator(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcLabel objectType, IfcObjectPlacement objectPlacement,
            IfcProductRepresentation representation, IfcIdentifier tag, IfcElectricGeneratorTypeEnum predefinedType) :
        ...
        public new static IfcElectricGenerator FromJson(string json)
        {
