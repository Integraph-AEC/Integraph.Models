...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcShadingDevice : IfcBuildingElement
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcShadingDevice(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcLabel objectType, IfcObjectPlacement objectPlacement,
            IfcProductRepresentation representation, IfcIdentifier tag, IfcShadingDeviceTypeEnum predefinedType) : base(
        ...
        public new static IfcShadingDevice FromJson(string json)
        {
