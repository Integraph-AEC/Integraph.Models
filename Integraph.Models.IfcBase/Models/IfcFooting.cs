...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcFooting : IfcBuildingElement
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcFooting(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcLabel objectType, IfcObjectPlacement objectPlacement,
            IfcProductRepresentation representation, IfcIdentifier tag, IfcFootingTypeEnum predefinedType) : base(
        ...
        public new static IfcFooting FromJson(string json)
        {
