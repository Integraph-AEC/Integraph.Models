...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcSpaceHeater : IfcFlowTerminal
    {
        ...
        public IfcSpaceHeater(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcSpaceHeaterTypeEnum predefinedType) : base(
        ...
        public new static IfcSpaceHeater FromJson(string json)
        {
