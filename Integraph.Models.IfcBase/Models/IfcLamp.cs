...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcLamp : IfcFlowTerminal
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcLamp(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description,
            IfcLabel objectType, IfcObjectPlacement objectPlacement, IfcProductRepresentation representation,
            IfcIdentifier tag, IfcLampTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcLamp FromJson(string json)
        {
