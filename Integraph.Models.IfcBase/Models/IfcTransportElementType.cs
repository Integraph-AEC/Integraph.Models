...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcTransportElementType : IfcElementType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcTransportElementType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcTransportElementTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcTransportElementType FromJson(string json)
        {
