...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcElementAssemblyType : IfcElementType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcElementAssemblyType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcElementAssemblyTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcElementAssemblyType FromJson(string json)
        {
