...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcAirTerminalType : IfcFlowTerminalType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcAirTerminalType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcAirTerminalTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcAirTerminalType FromJson(string json)
        {
