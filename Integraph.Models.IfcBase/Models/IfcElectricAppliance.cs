...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcElectricAppliance : IfcFlowTerminal
    {
        ...
        public IfcElectricAppliance(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcElectricApplianceTypeEnum predefinedType) :
        ...
        public new static IfcElectricAppliance FromJson(string json)
        {
