...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcProtectiveDeviceTrippingUnit : IfcDistributionControlElement
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcProtectiveDeviceTrippingUnit(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory,
            ...
            IfcProtectiveDeviceTrippingUnitTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcProtectiveDeviceTrippingUnit FromJson(string json)
        {
