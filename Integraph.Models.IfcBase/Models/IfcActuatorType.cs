...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcActuatorType : IfcDistributionControlElementType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcActuatorType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcActuatorTypeEnum predefinedType) : base(globalId, ownerHistory, name, description, applicableOccurrence,
        ...
        public new static IfcActuatorType FromJson(string json)
        {
