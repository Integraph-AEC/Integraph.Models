...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcUnitaryEquipment : IfcEnergyConversionDevice
    {
        ...
        public IfcUnitaryEquipment(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcUnitaryEquipmentTypeEnum predefinedType) :
        ...
        public new static IfcUnitaryEquipment FromJson(string json)
        {
