...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcLightFixture : IfcFlowTerminal
    {
        ...
        public IfcLightFixture(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcLightFixtureTypeEnum predefinedType) : base(
        ...
        public new static IfcLightFixture FromJson(string json)
        {
