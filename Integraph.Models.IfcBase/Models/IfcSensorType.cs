...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcSensorType : IfcDistributionControlElementType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcSensorType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcSensorTypeEnum predefinedType) : base(globalId, ownerHistory, name, description, applicableOccurrence,
        ...
        public new static IfcSensorType FromJson(string json)
        {
