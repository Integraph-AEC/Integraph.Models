...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcChimneyType : IfcBuildingElementType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcChimneyType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcChimneyTypeEnum predefinedType) : base(globalId, ownerHistory, name, description, applicableOccurrence,
        ...
        public new static IfcChimneyType FromJson(string json)
        {
