...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcTubeBundle : IfcEnergyConversionDevice
    {
        ...
        public IfcTubeBundle(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcTubeBundleTypeEnum predefinedType) : base(
        ...
        public new static IfcTubeBundle FromJson(string json)
        {
