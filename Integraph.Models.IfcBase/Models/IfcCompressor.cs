...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcCompressor : IfcFlowMovingDevice
    {
        ...
        public IfcCompressor(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcCompressorTypeEnum predefinedType) : base(
        ...
        public new static IfcCompressor FromJson(string json)
        {
