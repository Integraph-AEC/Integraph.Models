...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcValve : IfcFlowController
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcValve(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description,
            IfcLabel objectType, IfcObjectPlacement objectPlacement, IfcProductRepresentation representation,
            IfcIdentifier tag, IfcValveTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcValve FromJson(string json)
        {
