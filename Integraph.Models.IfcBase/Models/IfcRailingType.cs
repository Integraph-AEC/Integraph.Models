...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcRailingType : IfcBuildingElementType
    {
        ...
        public IfcRailingType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcRailingTypeEnum predefinedType) : base(globalId, ownerHistory, name, description, applicableOccurrence,
        ...
        public new static IfcRailingType FromJson(string json)
        {
