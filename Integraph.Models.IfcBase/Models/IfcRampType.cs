...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcRampType : IfcBuildingElementType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcRampType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcRampTypeEnum predefinedType) : base(globalId, ownerHistory, name, description, applicableOccurrence,
        ...
        public new static IfcRampType FromJson(string json)
        {
