...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcProtectiveDevice : IfcFlowController
    {
        ...
        public IfcProtectiveDevice(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcProtectiveDeviceTypeEnum predefinedType) :
        ...
        public new static IfcProtectiveDevice FromJson(string json)
        {
