...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcFlowInstrument : IfcDistributionControlElement
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcFlowInstrument(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcLabel objectType, IfcObjectPlacement objectPlacement,
            IfcProductRepresentation representation, IfcIdentifier tag, IfcFlowInstrumentTypeEnum predefinedType) :
        ...
        public new static IfcFlowInstrument FromJson(string json)
        {
