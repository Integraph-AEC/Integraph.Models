...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcBoiler : IfcEnergyConversionDevice
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcBoiler(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description,
            IfcLabel objectType, IfcObjectPlacement objectPlacement, IfcProductRepresentation representation,
            IfcIdentifier tag, IfcBoilerTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcBoiler FromJson(string json)
        {
