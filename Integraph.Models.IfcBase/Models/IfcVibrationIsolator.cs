...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcVibrationIsolator : IfcElementComponent
    {
        ...
        public IfcVibrationIsolator(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcVibrationIsolatorTypeEnum predefinedType) :
        ...
        public new static IfcVibrationIsolator FromJson(string json)
        {
