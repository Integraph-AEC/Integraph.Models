...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcChillerType : IfcEnergyConversionDeviceType
    {
        ...
        public IfcChillerType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcChillerTypeEnum predefinedType) : base(globalId, ownerHistory, name, description, applicableOccurrence,
        ...
        public new static IfcChillerType FromJson(string json)
        {
