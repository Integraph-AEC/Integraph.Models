...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcCompressorType : IfcFlowMovingDeviceType
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcCompressorType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcIdentifier applicableOccurrence, List<IfcPropertySetDefinition> hasPropertySets,
            List<IfcRepresentationMap> representationMaps, IfcLabel tag, IfcLabel elementType,
            IfcCompressorTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcCompressorType FromJson(string json)
        {
