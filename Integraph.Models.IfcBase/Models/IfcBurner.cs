...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcBurner : IfcEnergyConversionDevice
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcBurner(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description,
            IfcLabel objectType, IfcObjectPlacement objectPlacement, IfcProductRepresentation representation,
            IfcIdentifier tag, IfcBurnerTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcBurner FromJson(string json)
        {
