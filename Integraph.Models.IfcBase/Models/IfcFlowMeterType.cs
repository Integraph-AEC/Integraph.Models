...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcFlowMeterType : IfcFlowControllerType
    {
        ...
        public IfcFlowMeterType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcFlowMeterTypeEnum predefinedType) : base(globalId, ownerHistory, name, description, applicableOccurrence,
        ...
        public new static IfcFlowMeterType FromJson(string json)
        {
