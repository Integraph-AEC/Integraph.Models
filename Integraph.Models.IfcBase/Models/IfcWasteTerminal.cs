...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcWasteTerminal : IfcFlowTerminal
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcWasteTerminal(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcLabel objectType, IfcObjectPlacement objectPlacement,
            IfcProductRepresentation representation, IfcIdentifier tag, IfcWasteTerminalTypeEnum predefinedType) : base(
        ...
        public new static IfcWasteTerminal FromJson(string json)
        {
