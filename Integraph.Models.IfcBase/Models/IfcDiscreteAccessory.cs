...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcDiscreteAccessory : IfcElementComponent
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcDiscreteAccessory(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcLabel objectType, IfcObjectPlacement objectPlacement,
            IfcProductRepresentation representation, IfcIdentifier tag, IfcDiscreteAccessoryTypeEnum predefinedType) :
        ...
        public new static IfcDiscreteAccessory FromJson(string json)
        {
