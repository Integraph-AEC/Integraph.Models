...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcHeatExchanger : IfcEnergyConversionDevice
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcHeatExchanger(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            IfcText description, IfcLabel objectType, IfcObjectPlacement objectPlacement,
            IfcProductRepresentation representation, IfcIdentifier tag, IfcHeatExchangerTypeEnum predefinedType) : base(
        ...
        public new static IfcHeatExchanger FromJson(string json)
        {
