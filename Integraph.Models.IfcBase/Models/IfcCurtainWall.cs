...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcCurtainWall : IfcBuildingElement
    {
        ...
        public IfcCurtainWall(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcCurtainWallTypeEnum predefinedType) : base(
        ...
        public new static IfcCurtainWall FromJson(string json)
        {
