...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcSlab : IfcBuildingElement
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcSlab(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description,
            IfcLabel objectType, IfcObjectPlacement objectPlacement, IfcProductRepresentation representation,
            IfcIdentifier tag, IfcSlabTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcSlab FromJson(string json)
        {
