...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcElectricDistributionBoardType : IfcFlowControllerType
    {
	    ...
	    /// </summary>
	    public IfcElectricDistributionBoardType(IfcGloballyUniqueId globalId,
            IfcElectricDistributionBoardTypeEnum predefinedType) : base(globalId)
        {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcElectricDistributionBoardType(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory,
            ...
            IfcLabel elementType, IfcElectricDistributionBoardTypeEnum predefinedType) : base(globalId, ownerHistory,
        ...
        public new static IfcElectricDistributionBoardType FromJson(string json)
        {
