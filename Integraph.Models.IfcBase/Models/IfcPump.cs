...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcPump : IfcFlowMovingDevice
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcPump(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description,
            IfcLabel objectType, IfcObjectPlacement objectPlacement, IfcProductRepresentation representation,
            IfcIdentifier tag, IfcPumpTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcPump FromJson(string json)
        {
