...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcFireSuppressionTerminalType : IfcFlowTerminalType
    {
	    ...
	    /// </summary>
	    public IfcFireSuppressionTerminalType(IfcGloballyUniqueId globalId,
            IfcFireSuppressionTerminalTypeEnum predefinedType) : base(globalId)
        {
        ...
        public new static IfcFireSuppressionTerminalType FromJson(string json)
        {
