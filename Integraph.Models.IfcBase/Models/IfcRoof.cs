...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcRoof : IfcBuildingElement
    {
	    ...
	    /// </summary>
	    [JsonConstructor]
        public IfcRoof(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name, IfcText description,
            IfcLabel objectType, IfcObjectPlacement objectPlacement, IfcProductRepresentation representation,
            IfcIdentifier tag, IfcRoofTypeEnum predefinedType) : base(globalId, ownerHistory, name, description,
        ...
        public new static IfcRoof FromJson(string json)
        {
