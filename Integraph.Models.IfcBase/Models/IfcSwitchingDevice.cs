...
namespace Integraph.Models.IfcBase.Models
{
	...
	public class IfcSwitchingDevice : IfcFlowController
    {
        ...
        public IfcSwitchingDevice(IfcGloballyUniqueId globalId, IfcOwnerHistory ownerHistory, IfcLabel name,
            ...
            IfcProductRepresentation representation, IfcIdentifier tag, IfcSwitchingDeviceTypeEnum predefinedType) :
        ...
        public new static IfcSwitchingDevice FromJson(string json)
        {
