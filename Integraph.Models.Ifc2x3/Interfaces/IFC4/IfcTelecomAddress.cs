...
namespace Integraph.Models.Ifc2x3.ActorResource
{
	public partial class @IfcTelecomAddress : IIfcTelecomAddress
	{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcLabel> IIfcTelecomAddress.TelephoneNumbers 
		{ 
			get
			{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcLabel> IIfcTelecomAddress.FacsimileNumbers 
		{ 
			get
			{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcLabel> IIfcTelecomAddress.ElectronicMailAddresses 
		{ 
			get
			{
		...
		IItemSet<Integraph.Models.Ifc4.ExternalReferenceResource.IfcURIReference> IIfcTelecomAddress.MessagingIDs 
		{ 
			get
			{
