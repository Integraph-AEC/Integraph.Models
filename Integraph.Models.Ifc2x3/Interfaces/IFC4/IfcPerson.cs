...
namespace Integraph.Models.Ifc2x3.ActorResource
{
	public partial class @IfcPerson : IIfcPerson
	{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcLabel> IIfcPerson.MiddleNames 
		{ 
			get
			{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcLabel> IIfcPerson.PrefixTitles 
		{ 
			get
			{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcLabel> IIfcPerson.SuffixTitles 
		{ 
			get
			{
