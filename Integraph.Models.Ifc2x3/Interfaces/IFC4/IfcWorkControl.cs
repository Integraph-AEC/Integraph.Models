	...
	public partial class @IfcWorkControl : IIfcWorkControl
	{
		...
		{ 
			get
			{
                ...
                return new Integraph.Models.Ifc4.DateTimeResource.IfcDateTime(CreationDate.ToISODateTimeString());
				//##
			} 
			set
			{
		...
		{ 
			get
			{
                ...
                return new Integraph.Models.Ifc4.DateTimeResource.IfcDuration(Duration.Value.ToISODateTimeString());
				//##
			} 
			set
			{
		...
		{ 
			get
			{
                ...
                return new Integraph.Models.Ifc4.DateTimeResource.IfcDuration(TotalFloat.Value.ToISODateTimeString());
				//##
			} 
			set
			{
		...
		{ 
			get
			{
                ...
                return new Integraph.Models.Ifc4.DateTimeResource.IfcDateTime(StartTime.ToISODateTimeString());
				//##
			} 
			set
			{
		...
		{ 
			get
			{
                ...
                return new Integraph.Models.Ifc4.DateTimeResource.IfcDateTime(FinishTime.ToISODateTimeString());
				//##
			} 
			set
			{
