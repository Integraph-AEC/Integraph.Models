...
namespace Integraph.Models.Ifc2x3.SharedBldgElements
{
	public partial class @IfcRelConnectsPathElements : IIfcRelConnectsPathElements
	{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcInteger> IIfcRelConnectsPathElements.RelatingPriorities 
		{ 
			get
			{
		...
		IItemSet<Integraph.Models.Ifc4.MeasureResource.IfcInteger> IIfcRelConnectsPathElements.RelatedPriorities 
		{ 
			get
			{
