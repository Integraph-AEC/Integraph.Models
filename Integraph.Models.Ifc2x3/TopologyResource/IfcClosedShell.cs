...
namespace Integraph.Models.Ifc2x3.Interfaces
{
	...
	public partial interface @IIfcClosedShell : IIfcConnectedFaceSet, IfcShell
	{
...
namespace Integraph.Models.Ifc2x3.TopologyResource
{
	...
	public  partial class @IfcClosedShell : IfcConnectedFaceSet, IInstantiableEntity, IIfcClosedShell, IContainsEntityReferences, IEquatable<@IfcClosedShell>
	{
		...
		internal IfcClosedShell(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
