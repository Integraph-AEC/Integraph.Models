...
namespace Integraph.Models.Ifc2x3.Kernel
{
    public partial class IfcProject
    {
        ...
        /// </summary>
        public IEnumerable<Integraph.Models.Ifc4.Interfaces.IIfcBuilding> Buildings
        {
            get
            {
        ...
        public IEnumerable<Integraph.Models.Ifc4.Interfaces.IIfcSpatialStructureElement> SpatialStructuralElements
        {
            get
            {
                IEnumerable<IfcRelAggregates> aggregate = IsDecomposedBy.OfType<IfcRelAggregates>();
        ...
        public IEnumerable<Integraph.Models.Ifc4.Interfaces.IIfcSite> Sites
        {
            get
            {
