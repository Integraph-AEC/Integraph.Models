	...
	public partial class IfcValveType : IExpressValidatable
	{
		...
		public bool ValidateClause(IfcValveTypeClause clause) {
			...
			try
			{
				...
				var log = Validation.ValidationLogging.CreateLogger<Integraph.Models.Ifc2x3.HVACDomain.IfcValveType>();
		...
		public override IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(IfcValveTypeClause.WR1))
				yield return new ValidationResult() { Item = this, IssueSource = "IfcValveType.WR1", IssueType = ValidationFlags.EntityWhereClauses };
		}
	}
}
