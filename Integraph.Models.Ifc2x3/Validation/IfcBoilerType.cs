	...
	public partial class IfcBoilerType : IExpressValidatable
	{
		...
		public bool ValidateClause(IfcBoilerTypeClause clause) {
			...
			try
			{
				...
				var log = Validation.ValidationLogging.CreateLogger<Integraph.Models.Ifc2x3.HVACDomain.IfcBoilerType>();
		...
		public override IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(IfcBoilerTypeClause.WR1))
				yield return new ValidationResult() { Item = this, IssueSource = "IfcBoilerType.WR1", IssueType = ValidationFlags.EntityWhereClauses };
		}
	}
}
