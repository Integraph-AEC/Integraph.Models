	...
	public partial class IfcCartesianTransformationOperator : IExpressValidatable
	{
		...
		public bool ValidateClause(IfcCartesianTransformationOperatorClause clause) {
			...
			try
			{
				switch (clause)
				{
					case IfcCartesianTransformationOperatorClause.WR1:
						retVal = Scl > 0;
						break;
				}
			} catch (Exception ex) {
				var log = Validation.ValidationLogging.CreateLogger<Integraph.Models.Ifc2x3.GeometryResource.IfcCartesianTransformationOperator>();
