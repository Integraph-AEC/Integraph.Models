...
namespace Integraph.Models.Ifc2x3.StructuralAnalysisDomain
{
	...
	public  partial class @IfcStructuralLinearActionVarying : IfcStructuralLinearAction, IInstantiableEntity, IIfcStructuralLinearActionVarying, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcStructuralLinearActionVarying>
	{
		...
		[EntityAttribute(14, EntityAttributeState.Mandatory, EntityAttributeType.List, EntityAttributeType.Class, new int [] { 1 }, new int [] { -1 }, 21)]
		...
		[EntityAttribute(0, EntityAttributeState.Derived, EntityAttributeType.List, EntityAttributeType.Class, new int [] { 2 }, new int [] { -1 }, 0)]
