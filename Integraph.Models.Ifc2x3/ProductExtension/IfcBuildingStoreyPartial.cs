...
namespace Integraph.Models.Ifc2x3.ProductExtension
{
    public partial class IfcBuildingStorey
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Integraph.Models.Ifc4.Interfaces.IIfcSpace> Spaces
        {
            get
            {              
        ...
        public IEnumerable<Integraph.Models.Ifc4.Interfaces.IIfcBuildingStorey> BuildingStoreys
        {
            get
            {
