...
{
	/// <summary>
    /// Readonly interface for IfcPreDefinedPointMarkerSymbol
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcPreDefinedPointMarkerSymbol : IIfcPreDefinedSymbol
	{
...
namespace Integraph.Models.Ifc2x3.PresentationDimensioningResource
{
	...
	public  partial class @IfcPreDefinedPointMarkerSymbol : IfcPreDefinedSymbol, IInstantiableEntity, IIfcPreDefinedPointMarkerSymbol, IEquatable<@IfcPreDefinedPointMarkerSymbol>
	{
		...
		internal IfcPreDefinedPointMarkerSymbol(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
