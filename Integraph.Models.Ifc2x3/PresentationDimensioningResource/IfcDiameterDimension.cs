...
namespace Integraph.Models.Ifc2x3.PresentationDimensioningResource
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcDiameterDimension : IfcDimensionCurveDirectedCallout, IInstantiableEntity, IIfcDiameterDimension, IContainsEntityReferences, IEquatable<@IfcDiameterDimension>
	{
		...
		internal IfcDiameterDimension(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
        ...
        public bool Equals(@IfcDiameterDimension other)
	    {
	        return this == other;
	    }
        #endregion
