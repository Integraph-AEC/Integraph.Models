...
{
	/// <summary>
    /// Readonly interface for IfcBoundaryCondition
    /// </summary>
...
namespace Integraph.Models.Ifc2x3.StructuralLoadResource
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public abstract partial class @IfcBoundaryCondition : PersistEntity, IIfcBoundaryCondition, IEquatable<@IfcBoundaryCondition>
	{
		...
		internal IfcBoundaryCondition(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
