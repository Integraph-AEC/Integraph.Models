...
{
	/// <summary>
    /// Readonly interface for IfcCivilElement
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcCivilElement : IIfcElement
	{
...
namespace Integraph.Models.Ifc4.ProductExtension
{
	...
	public  partial class @IfcCivilElement : IfcElement, IInstantiableEntity, IIfcCivilElement, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcCivilElement>
	{
		...
		internal IfcCivilElement(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
        ...
        public bool Equals(@IfcCivilElement other)
	    {
	        return this == other;
	    }
        #endregion
