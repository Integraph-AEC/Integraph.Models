...
{
	/// <summary>
    /// Readonly interface for IfcPileType
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcPileType : IIfcBuildingElementType
	{
...
namespace Integraph.Models.Ifc4.StructuralElementsDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcPileType : IfcBuildingElementType, IInstantiableEntity, IIfcPileType, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcPileType>
	{
		#region IIfcPileType explicit implementation
		IfcPileTypeEnum IIfcPileType.PredefinedType { 
		...
		internal IfcPileType(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
