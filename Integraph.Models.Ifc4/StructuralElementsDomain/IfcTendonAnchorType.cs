...
namespace Integraph.Models.Ifc4.StructuralElementsDomain
{
	...
	public  partial class @IfcTendonAnchorType : IfcReinforcingElementType, IInstantiableEntity, IIfcTendonAnchorType, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcTendonAnchorType>
	{
		...
		internal IfcTendonAnchorType(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 8: 
					...
					return;
				case 9: 
                    _predefinedType = (IfcTendonAnchorTypeEnum) System.Enum.Parse(typeof (IfcTendonAnchorTypeEnum), value.EnumVal, true);
					return;
				default:
