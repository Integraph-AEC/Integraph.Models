...
namespace Integraph.Models.Ifc4.StructuralElementsDomain
{
	...
	public  partial class @IfcVoidingFeature : IfcFeatureElementSubtraction, IInstantiableEntity, IIfcVoidingFeature, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcVoidingFeature>
	{
		...
		internal IfcVoidingFeature(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcVoidingFeatureTypeEnum) System.Enum.Parse(typeof (IfcVoidingFeatureTypeEnum), value.EnumVal, true);
					return;
				default:
