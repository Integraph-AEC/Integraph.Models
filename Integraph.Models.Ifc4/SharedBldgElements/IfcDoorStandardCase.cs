...
namespace Integraph.Models.Ifc4.SharedBldgElements
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcDoorStandardCase : IfcDoor, IInstantiableEntity, IIfcDoorStandardCase, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcDoorStandardCase>
	{
		...
		internal IfcDoorStandardCase(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
