	...
	public partial class IfcTubeBundleType : IExpressValidatable
	{
		...
		public bool ValidateClause(IfcTubeBundleTypeClause clause) {
			...
			try
			{
				switch (clause)
				{
					case IfcTubeBundleTypeClause.CorrectPredefinedType:
				...
				var log = Validation.ValidationLogging.CreateLogger<Integraph.Models.Ifc4.HvacDomain.IfcTubeBundleType>();
		...
		public override IEnumerable<ValidationResult> Validate()
		{
			...
			if (!ValidateClause(IfcTubeBundleTypeClause.CorrectPredefinedType))
