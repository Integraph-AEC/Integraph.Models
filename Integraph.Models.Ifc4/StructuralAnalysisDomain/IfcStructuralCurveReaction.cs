...
{
	/// <summary>
    /// Readonly interface for IfcStructuralCurveReaction
    /// </summary>
...
namespace Integraph.Models.Ifc4.StructuralAnalysisDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcStructuralCurveReaction : IfcStructuralReaction, IInstantiableEntity, IIfcStructuralCurveReaction, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcStructuralCurveReaction>
	{
		...
		internal IfcStructuralCurveReaction(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
