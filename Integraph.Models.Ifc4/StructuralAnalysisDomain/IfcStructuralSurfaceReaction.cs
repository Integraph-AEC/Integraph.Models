...
{
	/// <summary>
    /// Readonly interface for IfcStructuralSurfaceReaction
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcStructuralSurfaceReaction : IIfcStructuralReaction
	{
...
namespace Integraph.Models.Ifc4.StructuralAnalysisDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcStructuralSurfaceReaction : IfcStructuralReaction, IInstantiableEntity, IIfcStructuralSurfaceReaction, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcStructuralSurfaceReaction>
	{
		...
		internal IfcStructuralSurfaceReaction(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
