...
namespace Integraph.Models.Ifc4.PlumbingFireProtectionDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcSanitaryTerminal : IfcFlowTerminal, IInstantiableEntity, IIfcSanitaryTerminal, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcSanitaryTerminal>
	{
		...
		internal IfcSanitaryTerminal(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcSanitaryTerminalTypeEnum) System.Enum.Parse(typeof (IfcSanitaryTerminalTypeEnum), value.EnumVal, true);
					return;
				default:
