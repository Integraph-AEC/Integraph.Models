...
{
	/// <summary>
    /// Readonly interface for IfcDuctFitting
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcDuctFitting : IIfcFlowFitting
	{
...
namespace Integraph.Models.Ifc4.HvacDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcDuctFitting : IfcFlowFitting, IInstantiableEntity, IIfcDuctFitting, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcDuctFitting>
	{
		...
		internal IfcDuctFitting(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcDuctFittingTypeEnum) System.Enum.Parse(typeof (IfcDuctFittingTypeEnum), value.EnumVal, true);
					return;
				default:
