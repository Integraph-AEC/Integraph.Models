...
namespace Integraph.Models.Ifc4.HvacDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcMedicalDevice : IfcFlowTerminal, IInstantiableEntity, IIfcMedicalDevice, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcMedicalDevice>
	{
		#region IIfcMedicalDevice explicit implementation
		IfcMedicalDeviceTypeEnum? IIfcMedicalDevice.PredefinedType { 
		...
		internal IfcMedicalDevice(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcMedicalDeviceTypeEnum) System.Enum.Parse(typeof (IfcMedicalDeviceTypeEnum), value.EnumVal, true);
					return;
				default:
