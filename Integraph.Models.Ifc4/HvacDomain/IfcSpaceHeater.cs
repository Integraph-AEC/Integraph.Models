...
{
	/// <summary>
    /// Readonly interface for IfcSpaceHeater
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcSpaceHeater : IIfcFlowTerminal
	{
...
namespace Integraph.Models.Ifc4.HvacDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcSpaceHeater : IfcFlowTerminal, IInstantiableEntity, IIfcSpaceHeater, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcSpaceHeater>
	{
		...
		internal IfcSpaceHeater(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcSpaceHeaterTypeEnum) System.Enum.Parse(typeof (IfcSpaceHeaterTypeEnum), value.EnumVal, true);
					return;
				default:
