...
{
	/// <summary>
    /// Readonly interface for IfcAirToAirHeatRecovery
    /// </summary>
...
namespace Integraph.Models.Ifc4.HvacDomain
{
	...
	public  partial class @IfcAirToAirHeatRecovery : IfcEnergyConversionDevice, IInstantiableEntity, IIfcAirToAirHeatRecovery, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcAirToAirHeatRecovery>
	{
		...
		internal IfcAirToAirHeatRecovery(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcAirToAirHeatRecoveryTypeEnum) System.Enum.Parse(typeof (IfcAirToAirHeatRecoveryTypeEnum), value.EnumVal, true);
					return;
				default:
