...
namespace Integraph.Models.Ifc4.ElectricalDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcTransformer : IfcEnergyConversionDevice, IInstantiableEntity, IIfcTransformer, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcTransformer>
	{
		#region IIfcTransformer explicit implementation
		IfcTransformerTypeEnum? IIfcTransformer.PredefinedType { 
		...
		internal IfcTransformer(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcTransformerTypeEnum) System.Enum.Parse(typeof (IfcTransformerTypeEnum), value.EnumVal, true);
					return;
				default:
