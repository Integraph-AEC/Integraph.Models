...
{
	/// <summary>
    /// Readonly interface for IfcElectricMotor
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcElectricMotor : IIfcEnergyConversionDevice
	{
...
namespace Integraph.Models.Ifc4.ElectricalDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcElectricMotor : IfcEnergyConversionDevice, IInstantiableEntity, IIfcElectricMotor, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcElectricMotor>
	{
		...
		internal IfcElectricMotor(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcElectricMotorTypeEnum) System.Enum.Parse(typeof (IfcElectricMotorTypeEnum), value.EnumVal, true);
					return;
				default:
