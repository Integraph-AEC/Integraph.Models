...
{
	/// <summary>
    /// Readonly interface for IfcCableCarrierFitting
    /// </summary>
	// ReSharper disable once PartialTypeWithSinglePart
	public partial interface @IIfcCableCarrierFitting : IIfcFlowFitting
	{
...
namespace Integraph.Models.Ifc4.ElectricalDomain
{
	...
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcCableCarrierFitting : IfcFlowFitting, IInstantiableEntity, IIfcCableCarrierFitting, IContainsEntityReferences, IContainsIndexedReferences, IEquatable<@IfcCableCarrierFitting>
	{
		...
		internal IfcCableCarrierFitting(IModel model, int label, bool activated) : base(model, label, activated)  
		{
		}
		...
		public override void Parse(int propIndex, IPropertyValue value, int[] nestedIndex)
		{
			switch (propIndex)
			{
				...
				case 7: 
					...
					return;
				case 8: 
                    _predefinedType = (IfcCableCarrierFittingTypeEnum) System.Enum.Parse(typeof (IfcCableCarrierFittingTypeEnum), value.EnumVal, true);
					return;
				default:
